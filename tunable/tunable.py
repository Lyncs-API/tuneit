...
def variable(var, value=None, label=None, uid=None):
    """
    A tunable variable.
    ...
    return Tunable(Variable(var, value=value, label=label, uid=uid))
...
class Variable(Object):
    ...
    @property
    def __dot_attrs__(self):
        return dict(shape="diamond", color="red")
